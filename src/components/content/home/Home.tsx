            ...
            <div className="container relative px-4">
                {
                    homeData.map((Item, idx) => {
                        return (
                            <div key={idx} className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-16 py-8 md:py-12">
                                <div className="flex-1 space-y-6 md:space-y-8 text-center lg:text-left">
                                    <div className="space-y-4 md:space-y-6">
                                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent leading-tight tracking-tight">
                                            {Item.title}
                                        </h1>
                                ...
                                <div className="flex-1 relative w-full max-w-xl mt-8 lg:mt-0">
                                    ...
                                    <div className="relative aspect-square w-full overflow-hidden rounded-3xl shadow-2xl transform hover:scale-[1.02] transition-transform duration-500">
                                        <Image
                                            src={Item.imageUrl}
                                            alt={Item.title}
                                            fill
