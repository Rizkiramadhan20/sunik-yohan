...
import ShipingModal from './modal/ShipingModal'

import DeliveryModal from './modal/DeliveryModal'

import { useManagementTransactionPending } from './utils/UseManagementTransactionPending'

export default function TransactionLayout() {
    const { transactions, loading, updateTransactionStatus, deliveryStages } = useManagementTransactionPending();
        ...
        <section>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border border-gray-100 p-4 rounded-2xl gap-4">
                <div className="space-y-1">
                    <div className="flex items-center gap-2 pb-4">
                        ...
                        <h1 className="text-3xl font-bold tracking-tight">Transaction Pending</h1>
                    </div>
            ...
            {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 px-4">
                    ...
                    <h3 className="text-xl font-semibold text-gray-700 mb-2">Tidak Ada Transaksi Pengiriman yang Tertunda</h3>
                    <p className="text-gray-500 text-center max-w-md">
                        Saat ini tidak ada transaksi pengiriman yang tertunda untuk ditampilkan. Transaksi baru akan muncul di sini ketika dibuat.
                    </p>
                </div>
            ) : (
                                ...
                                <div className="space-y-4 sm:space-y-6">
                                    ...
                                    <div className="border-t pt-4">
                                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                            ...
                                            <ShipingModal shippingInfo={transaction.shippingInfo} />

                                            <DeliveryModal deliveryStatus={transaction.deliveryStatus} />
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
