                    ...
                    <div className="border-t pt-4 mt-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div className="flex justify-between items-center p-3 sm:p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                ...
                                <span className="font-semibold text-sm sm:text-lg bg-blue-50 text-blue-600 px-3 sm:px-4 py-1 rounded-full">{transaction.items.reduce((total: number, item: any) => total + item.quantity, 0)} items</span>
                            </div>
                            <div className="flex justify-between items-center p-3 sm:p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <span className="font-semibold text-sm sm:text-lg bg-purple-50 text-purple-600 px-3 sm:px-4 py-1 rounded-full">{formatCurrency(transaction.items.reduce((total: number, item: any) => total + (item.price * item.quantity * 1000), 0))}</span>
                            </div>
                            <div className="flex justify-between items-center p-3 sm:p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div className="flex justify-between items-center p-3 sm:p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                ...
                                <span className="font-semibold text-sm sm:text-lg bg-orange-50 text-orange-600 px-3 sm:px-4 py-1 rounded-full">{formatCurrency(transaction.items.reduce((total: number, item: any) => total + (item.price * item.quantity * 1000), 0) + transaction.shippingCost)}</span>
                            </div>
                        </div>
                    </div>
                </div>
