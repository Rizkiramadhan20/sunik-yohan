...
export default function ShippingInfo({ shippingInfo }: ShippingInfoProps) {
    return (
        <Dialog>
                    ...
                    <div className="bg-gray-50 rounded-lg space-y-4">
                        ...
                        <div className="p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h4 className="font-semibold text-base">Detail Penerima</h4>
                            </div>
                            <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-sm font-medium">{shippingInfo.firstName}</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-500">
                        ...
                        <div className="p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium">{shippingInfo.streetName}</p>
                                        <p className="text-sm text-gray-600">
                                            {shippingInfo.city}, {shippingInfo.province} {shippingInfo.postalCode}
                                        </p>
                                        <p className="text-sm text-gray-600">
                                            RT: {shippingInfo.rt} / RW: {shippingInfo.rw}
                                        </p>
                        ...
                        <div className="p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h4 className="font-semibold text-base">Informasi Tambahan</h4>
                            </div>
                            <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-500">
                                    ...
                                    <p className="text-sm">
                                        Tipe Alamat: <span className="font-medium capitalize">{shippingInfo.addressType}</span>
                                    </p>
                                </div>
                                {shippingInfo.district && (
                                    <div className="flex items-center gap-2">
                                        ...
                                        <p className="text-sm">
                                            Koordinat: <span className="font-medium">{shippingInfo.district}</span>
                                        </p>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h4 className="font-semibold text-base">Peta Lokasi</h4>
                            </div>
                            <div className="w-full h-[300px] rounded-lg overflow-hidden border border-gray-200">
                                {shippingInfo.district && (
                                    <iframe
                                        ...
                                        height="100%"
                                        frameBorder="0"
                                        src={`https://www.openstreetmap.org/export/embed.html?bbox=${parseFloat(shippingInfo.district.split(',')[1]) - 0.01}%2C${parseFloat(shippingInfo.district.split(',')[0]) - 0.002}%2C${parseFloat(shippingInfo.district.split(',')[1]) + 0.01}%2C${parseFloat(shippingInfo.district.split(',')[0]) + 0.002}&layer=mapnik&marker=${shippingInfo.district.split(',')[0]},${shippingInfo.district.split(',')[1]}`}
                                        allowFullScreen
                                    />
                                )}
                            </div>
