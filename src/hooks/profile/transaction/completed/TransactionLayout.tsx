...
export default function TransactionLayout() {
    ...
    const filteredTransactions = transactions.filter(transaction => {
        ...
        return transaction.deliveryStatus.status === 'completed'
    })
            ...
            <div>
                <div className="container px-4 py-12">
                    <div className="text-center max-w-2xl mx-auto">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-4">Tidak Ada Transaksi Selesai</h2>
                        <p className="text-gray-600 text-lg mb-8">Anda tidak memiliki transaksi selesai apa pun saat ini.</p>
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            <div className="flex items-center justify-center gap-3 text-gray-500">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                </svg>
                                <p className="text-sm">Riwayat transaksi Anda akan muncul di sini setelah Anda memiliki pesanan yang Selesai</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex gap-6 items-center">
                        <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-lg">
                            ...
                            <p className="text-gray-700 font-medium">Total Transaksi Selesai: <span className="text-blue-600 font-bold">{filteredTransactions.length}</span></p>
                        </div>
